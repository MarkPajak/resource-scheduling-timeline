angular.module('app').controller('TallyController', ['$scope', 'Tallys', function($scope, Tallys) {
    $scope.editing = [];
...
angular.module('app').controller('trello', ['$scope',
    '$http',
    '$q',
    '$routeParams',
    '$location',
    'screen_saver_loop',
    '$rootScope',
    'detect_dragging', 'trello', 'get_trello_board', 'date_calc', 'Todos', 'Tallys','Team',
