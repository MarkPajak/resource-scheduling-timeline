        ...
        // Services
        //---------------
        angular.module('app').factory('Tallys', ['$resource', function($resource){
          return $resource('/tallys/:id', null, {
            'update': { method:'PUT' }
          });
        }])
		
		  angular.module('app').factory('Timeline', ['$resource', function($resource){
		  ...
		  angular.module('app').factory('Team', ['$resource', function($resource){
        ...
        angular.module('app').factory('Todos', ['$resource', function($resource){
		...
		.factory('date_calc', ['$http', function ($http) {
...
angular.module('app').factory('trello', ['$http', function ($http) {
			var trello = {};
...
angular.module('app').factory('get_trello_board', ['Team','Tallys','date_calc', '$http','$rootScope', function (Team,Tallys,date_calc,$http,$rootScope) {
...
angular.module('app').factory('detect_dragging', function($rootScope) {
...
angular.module('app').factory('screen_saver_loop', function($rootScope,$location,$interval,Team) {
