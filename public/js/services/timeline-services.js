		  ...
		  angular.module('app').factory('timeline_functions', ['$http','Timeline','$rootScope', function ($http,Timeline,$rootScope) {
  return {
   ...
   get_events: function() {
	...
	var self=this
         ...
         var options = {
					...
					zoomMax: 1000 * 60 * 60 * 24 * 31 * 50 ,    // about six months in milliseconds
                    width: '100%',
					maxHeight:"900px",
					moveable:true,
